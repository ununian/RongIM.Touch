...
namespace RongIM.Touch
{
    ...
    [Native]
    public enum RCUserAvatarStyle : long
    {
        Rectangle = 0,
        Cycle
    }
    ...
    [Native]
    public enum RCConversationModelType : long
    {
        Normal = 1,
        Collection = 2,
        Customization = 3,
    ...
    [Native]
    public enum RCChatSessionInputBarControlStyle : long
    {
        SwitchContainerExtention = 0,
        ExtentionContainerSwitch = 1,
        ContainerSwitchExtention = 2,
        ContainerExtentionSwitch = 3,
        SwitchContainer = 4,
        ContainerSwitch = 5,
        ExtentionContainer = 6,
        ContainerExtention = 7,
        Container = 8
    }

    [Native]
    public enum RCChatSessionInputBarControlType : long
    {
        DefaultType = 0,
        PubType = 1,
        CSRobotType = 2,
    ...
    [Native]
    public enum RCChatSessionInputBarInputType : long
    {
        Text = 0,
        Voice = 1,
        Extention = 2
    ...
    [Native]
    public enum KBottomBarStatus : long
    {
        DefaultStatus = 0,
        KeyboardStatus,
        PluginStatus,
    ...
    [Native]
    public enum RCMessageBubbleTipViewAlignment : long
    {
        TopLeft,
        TopRight,
        TopCenter,
